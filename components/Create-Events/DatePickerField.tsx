...
const styles = StyleSheet.create({
    ...
    trigger: {
        ...
        borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, minHeight: 42,
    },
    triggerText: { flex: 1, color: "#fff", fontSize: 14 },
    ...
    modalHeader: {
        ...
        paddingHorizontal: 20, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: "#1e1e1e",
    },
    modalTitle: { color: "#fff", fontSize: 15, fontWeight: "600" },
    doneBtn: { color: "#4ade80", fontSize: 15, fontWeight: "700" },
});
