...
__export(context_exports, {
  ...
  useUserOnline: () => useUserOnline,
  useUserTyping: () => useUserTyping
});
...
var ChatFrontendClient = class extends import_eventemitter3.EventEmitter {
  constructor(options) {
    super();
    this.messageQueue = [];
...
var MessageContext = (0, import_react.createContext)(void 0);
var RoomContext = (0, import_react.createContext)(void 0);
var UserStatusContext = (0, import_react.createContext)(void 0);
var TypingContext = (0, import_react.createContext)(void 0);
...
var ChatProvider = ({ options, children }) => {
  ...
  const [userStatuses, setUserStatuses] = (0, import_react.useState)({});
  const [typingUsers, setTypingUsers] = (0, import_react.useState)({});
  const [rooms, setRooms] = (0, import_react.useState)([]);
  const [currentRoomData, setCurrentRoomData] = (0, import_react.useState)(null);
  const [currentRoomMedia, setCurrentRoomMedia] = (0, import_react.useState)([]);
  const [currentRoomMessages, setCurrentRoomMessages] = (0, import_react.useState)([]);
  ...
  const [fileUploadConfig, setFileUploadConfig] = (0, import_react.useState)({
    maxFiles: 5,
    maxFileSize: 25,
    acceptedTypes: [
      "image/*",
  ...
  const currentRoomIdRef = (0, import_react.useRef)(null);
  ...
  const chatContextValue = (0, import_react.useMemo)(
    () => ({
      client,
      isConnected,
      login,
  ...
  const messageContextValue = (0, import_react.useMemo)(
    () => ({
      sendMessage: (message) => {
  ...
  const roomContextValue = (0, import_react.useMemo)(
    () => ({
  ...
  const userStatusContextValue = (0, import_react.useMemo)(
    () => ({
  ...
  const typingContextValue = (0, import_react.useMemo)(
    () => ({
  ...
  const validateFile = (0, import_react.useCallback)((file) => {
  ...
  const uploadFiles = (0, import_react.useCallback)(async (roomId) => {
  ...
  const getFileIcon = (0, import_react.useCallback)((fileType) => {
  ...
  const formatFileSize = (0, import_react.useCallback)((bytes) => {
  ...
  const getSignedUrl = (0, import_react.useCallback)(async (fileId, options2 = {}) => {
  ...
  const previewFile = (0, import_react.useCallback)((fileIdOrUrl, options2 = {}) => {
  ...
  const fileUploadContextValue = (0, import_react.useMemo)(
    () => ({
      selectedFiles,
      addFiles,
      removeFile,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChatContext.Provider, { value: chatContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageContext.Provider, { value: messageContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RoomContext.Provider, { value: roomContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserStatusContext.Provider, { value: userStatusContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TypingContext.Provider, { value: typingContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileUploadContext.Provider, { value: fileUploadContextValue, children }) }) }) }) }) });
};
var useChat = () => {
...
var useChatRoom = () => {
  const context = (0, import_react.useContext)(RoomContext);
  if (!context) throw new Error("useChatRoom must be used within a ChatProvider");
  return context;
};
var useUserOnline = () => {
  const context = (0, import_react.useContext)(UserStatusContext);
  if (!context) throw new Error("useUserOnline must be used within a ChatProvider");
  return context;
};
var useUserTyping = () => {
  const context = (0, import_react.useContext)(TypingContext);
