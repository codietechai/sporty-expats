...
__export(hooks_exports, {
  useSparkStrandChat: () => useSparkStrandChat
});
...
function useSparkStrandChat(url, id, apiKey, options) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    socket.on("connect" /* CONNECT */, handleConnect);
    socket.on("disconnect" /* DISCONNECT */, handleDisconnect);
    socket.on("reconnect_attempt" /* RECONNECT_ATTEMPT */, handleReconnectAttempt);
    socket.on("reconnect" /* RECONNECT */, handleReconnect);
    socket.on("reconnect_error" /* RECONNECT_ERROR */, handleReconnectError);
    socket.on("reconnect_failed" /* RECONNECT_FAILED */, handleReconnectFailed);
    socket.on("authenticated" /* AUTHENTICATED */, handleAuthenticated);
    socket.on("auth_error" /* AUTH_ERROR */, handleAuthError);
    socket.on("listOfGuestRooms" /* LIST_OF_GUEST_ROOMS */, handleGuestRooms);
    socket.on("roomSwitched" /* ROOM_SWITCHED */, handleRoomSwitched);
    socket.on("roomJoined" /* ROOM_JOINED */, handleRoomJoined);
    socket.on("roomLeft" /* ROOM_LEFT */, handleRoomLeft);
    socket.on("roomCreated" /* ROOM_CREATED */, handleRoomCreated);
    socket.on("newMessage" /* NEW_MESSAGE */, handleNewMessage);
    socket.on("messageRead" /* MESSAGE_READ */, handleMessageRead);
    socket.on("userStatusChanged" /* USER_STATUS_CHANGED */, handleUserStatusChanged);
    socket.on("userOnline" /* USER_ONLINE */, handleUserOnline);
    socket.on("userTyping" /* USER_TYPING */, handleUserTyping);
    socket.on("userStoppedTyping" /* USER_STOPPED_TYPING */, handleUserStoppedTyping);
    socket.on("error" /* ERROR */, handleError);
    ...
    return () => {
      ...
      socket.off("reconnect_attempt" /* RECONNECT_ATTEMPT */);
      socket.off("reconnect" /* RECONNECT */);
      socket.off("reconnect_error" /* RECONNECT_ERROR */);
      socket.off("reconnect_failed" /* RECONNECT_FAILED */);
      socket.off("authenticated" /* AUTHENTICATED */);
      socket.off("auth_error" /* AUTH_ERROR */);
      socket.off("listOfGuestRooms" /* LIST_OF_GUEST_ROOMS */);
      socket.off("roomSwitched" /* ROOM_SWITCHED */);
      socket.off("roomJoined" /* ROOM_JOINED */);
      socket.off("roomLeft" /* ROOM_LEFT */);
      socket.off("roomCreated" /* ROOM_CREATED */);
      socket.off("newMessage" /* NEW_MESSAGE */);
      socket.off("messageRead" /* MESSAGE_READ */);
      socket.off("userStatusChanged" /* USER_STATUS_CHANGED */);
      socket.off("userOnline" /* USER_ONLINE */);
      socket.off("userTyping" /* USER_TYPING */);
      socket.off("userStoppedTyping" /* USER_STOPPED_TYPING */);
