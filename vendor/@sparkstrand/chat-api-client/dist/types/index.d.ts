 ...
 */
interface ICompanyDomainsInput {
    domainsToAdd: string[];
...
declare enum IPermissionEntityType {
    MODERATOR = "MODERATOR",
    ADMIN = "ADMIN",
    MEMBER = "MEMBER",
    ROLE = "ROLE",
...
declare enum IRoomPermissionType {
 ...
 */
interface IMessageFileUploader {
    /** Uploader ID */
    id: string;
    /** Uploader name */
    name: string;
 ...
 */
interface IMessageFileAttachement {
    /** Unique file ID */
    id: string;
...
interface IMessageSearchResult {
    messages: IMessage[];
    totalCount: number;
    hasMore: boolean;
    searchQuery?: string;
...
interface IMessageSearchFilter {
    senderId?: string;
...
interface IMessageSearchOptions {
    limit?: number;
    offset?: number;
...
export { type AuthenticatedData, type Avatar, type ErrorData, type FilePreview, type FileUploadConfig, type IAccessKey, type IAccessKeyInput, type ICompany, type ICompanyDomainsInput, type ICompanyInput, type ICreateRoom, type IDeleteMessage, type IEditMessage, type IGetUserMessages, type IGuest, type IGuestLogin, type IGuestMetaData, type ILocation, type IMessage, type IMessageFileAttachement, type IMessageFileUploader, type IMessageSearchFilter, type IMessageSearchOptions, type IMessageSearchResult, type IMessageSender, IPermissionEntityType, type IResponse, type IRoom, type IRoomGuests, type IRoomMedia, type IRoomPermission, IRoomPermissionType, type ISendMessage, type IUpdateMessage, type IUser, type IUserChangePasswordInput, type IUserLogin, type IUserSigninInput, type IUserSignupInput, type IUserUpdateInput, MessageStatus, Operators, type Pagination, type QueryCondition, type QueryNode, type RestClientAuthOptions, type RestClientOptions, RoomType, type SearchQuery, type SocketClientOptions, SocketEvent, type Sort, UserStatus };
